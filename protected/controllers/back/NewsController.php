...
class NewsController extends BackEndController {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('admin', 'delete', 'create', 'update', 'upload', 'listimages', 'image', 'remove', 'view'),
                'users' => array('@'),
            ),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['News'])) {
            ...
            if ($model->validate()) {
                ...
                if (@!empty($_FILES['News']['name']['images'])) {
                    $model->images = $_POST['News']['images'];
                ...
                if ($model->save()) {
                    ContentImage::model()->updateAll(array('content' => $model->id), 'content IS NULL');
                    Yii::app()->user->setFlash('success', 'News created successfully');
    ...
    public function actionUpdate($id) {
        ...
        //Display more picture grid
        $modelmore = new ContentImage('search_update');
        $modelmore->unsetAttributes();  // clear any default values
        if (isset($_GET['ContentImage']))
            $modelmore->attributes = $_GET['ContentImage'];
