...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'section',
            'type' => 'raw',
            'value' => 'NewsCategory::getSectionName($data->section)',
            'filter' => CHtml::activeDropDownList($model, 'section', CHtml::listData(NewsSections::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
            'htmlOptions' => array('style' => "text-align:left;", 'title' => 'News Section'),
        ),
        array(
            'name' => 'parent_id',
            'type' => 'raw',
            'value' => 'NewsCategory::getCategoryName($data->parent_id)',
            'filter' => CHtml::activeDropDownList($model, 'parent_id', CHtml::listData(NewsCategory::model()->findAll(array('condition' => 'published=1', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
