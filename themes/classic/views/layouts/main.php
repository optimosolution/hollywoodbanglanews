...
<html lang="en">
    <head>
        ...
        <meta name="google-translate-customization" content="d848af5f8ae8075f-3984b0e27bebc423-g0ad8378f8f8a68bf-17" />
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/hb.css" />
    ...
    <body>
        ...
        $this->widget('bootstrap.widgets.TbNavbar', array(
            ...
            'items' => array(
                array(
                    ...
                    'items' => array(
                        array('label' => $this->get_menu_name(26), 'icon' => 'home white', 'url' => array('/site/index')),
                        ...
                        array('label' => $this->get_menu_name(35), 'url' => '#',
                            'items' => array(
                                ...
                                array('label' => $this->get_menu_name(22), 'url' => array('/news/index', 'id' => 85)),
                            ),
                        ),
                ...
                array(
                    ...
                    'items' => array(
                        array('label' => Yii::app()->user->name, 'icon' => 'icon-user icon-white', 'url' => '#', 'items' => array(
        ...
        <div id="footer" style="height:165px; border-top:1px solid #F89406;background-color:#FFFFE3;">
            <div class="container">
                <p class="muted credit" style="font-size:16px;color:#000;"><?php echo $this->get_menu_name(48); ?>, CEO & Publisher: Syed Abed Nipu</p>
                <p class="muted credit" style="font-size:16px;color:#000;"><?php echo $this->get_menu_name(49); ?>, Chief Editor: Mamun Reazi</p>
                <p class="muted credit" style="font-size:16px;color:#000;"><?php echo $this->get_menu_name(55); ?>, Managing Editor: Abdus Samad</p>
                <p class="muted credit" style="font-size:14px;color:#000;"><?php echo $this->get_menu_name(50); ?></p>
                <p class="muted credit" style="color:#000;">E-Mail: <a href="mailto:hollywoodbangla@gmail.com">hollywoodbangla@gmail.com</a>, Hollywood , California, USA, Phone : (562) 688-1911</p>      
                <p class="muted credit" style="color:#000;">Copyright &copy; <?php echo date('Y'); ?> <?php echo Yii::app()->params['copyrightName']; ?>. All rights reserved. Website designed and developed by <?php echo CHtml::link('Optimo Solution', 'http://www.optimosolution.com', array('target' => '_blank')); ?></p>                 
            </div>
        </div>        
    </body>
</html>